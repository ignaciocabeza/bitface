  ...
  return (
    <div className="app-root">
      <header className="site-header">
        <img src="./favicon.svg" alt="bitface logo" className="site-logo" />
        <h1>bitface</h1>
        <p className="tagline">Pixel art SVG avatar generator with zero dependencies</p>
        <div className="header-actions">
          <code className="install-badge">npm install bitface</code>
      ...
      <footer className="site-footer">
        ...
        <a href="https://www.npmjs.com/package/bitface" target="_blank" rel="noopener">npm</a>
